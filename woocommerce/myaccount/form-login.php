...
<div class="row" id="customer_login">
    ...
    <div class="col-md-6">
        <p>Please <a href="/" class="join-savvy-links" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-user" aria-controls="offcanvas-user">Click Here</a> to register, or log in.</p>
    ...
    <div class="col-md-6">
        ...
        <?php if (0===1): ?>
        <!-- using if statement to hide password field -->
